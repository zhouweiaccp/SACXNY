...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[20,40,60,80],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_8b,_8c){
},onBeforeRefresh:function(_8d,_8e){
},onRefresh:function(_8f,_90){
},onChangePageSize:function(_91){
//},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} of {total} items"};
},beforePageText:"第",afterPageText:"页   共 {pages} 页",displayMsg:"第 {from} 到 {to} 条  共 {total} 条"};
})(jQuery);
(function($){
function _92(_93){
var _94=$(_93);
