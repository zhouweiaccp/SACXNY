...
<body>
            ...
            <td>
                <div>
                    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2" valign="middle" class="style3">
                                &nbsp;操作选项
                            </td>
                        </tr>
                        <tr height="40px">
                        ...
                        <tr height="30px">
                            ...
                            <td align="left" valign="middle" class="style7">
                                菜单编号:<input id="nId" type="text" runat="server" size="35" disabled="disabled" style="border: solid 1px #E0ECF9" /><input
                                    id="nPid" type="text" runat="server" size="5" />
                            </td>
                        </tr>
                        <tr height="30px">
                            <td class="style6">
                        ...
                        <tr height="30px">
                            ...
                            <td align="left" valign="middle" class="style7">
                                菜单序号:<input id="nOrder" type="text" runat="server" size="35" disabled="disabled"
                                    style="border: solid 1px #E0ECF9" />
                            </td>
                        </tr>
                        <tr height="30px">
                            <td class="style6">
                        ...
                        <tr height="30px">
                            ...
                            <td align="left" valign="middle" class="style7">
                                显示菜单:<input type="checkbox" runat="server" id="nVis" runat="server" disabled="disabled"
                                    style="border: solid 1px #E0ECF9" />
                            </td>
                        </tr>
                        <tr>
    ...
    <div id="dv_add" data-options="iconCls:'icon-save'" style="padding: 5px; width: 400px;
        background-color: #f2f5f7; height: 200px;">
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 菜单名称:&nbsp;
        <input id="txtName" class="easyui-validatebox" type="text" name="name" runat="server"
            style="border: solid 1px #E0ECF9; text-align: center;" size="35" /><br />
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 菜单序号:&nbsp;
        <input id="txtOrder" class="easyui-validatebox" type="text" name="name" runat="server"
            style="border: solid 1px #E0ECF9; text-align: center;" size="35" /><br />
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 菜单链接:&nbsp;
        <input id="txtUrl" class="easyui-validatebox" type="text" name="name" runat="server"
            style="border: solid 1px #E0ECF9; text-align: center;" size="35" /><br />
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 显示菜单:&nbsp;
        <input type="checkbox" id="txtVis" name="txtVis" checked="checked" runat="server" /><br />
        <br />
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
    ...
    <div id="dv_edit" data-options="iconCls:'icon-save'" style="padding: 5px; width: 400px;
        background-color: #f2f5f7; height: 200px;">
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 菜单名称:&nbsp;
        <input id="eName" class="easyui-validatebox" type="text" name="name" runat="server"
            style="border: solid 1px #E0ECF9; text-align: center;" size="35" /><br />
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 菜单序号:&nbsp;
        <input id="eOrder" class="easyui-validatebox" type="text" name="name" runat="server"
            style="border: solid 1px #E0ECF9; text-align: center;" size="35" /><br />
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 菜单链接:&nbsp;
        <input id="eUrl" class="easyui-validatebox" type="text" name="name" runat="server"
            style="border: solid 1px #E0ECF9; text-align: center;" size="35" /><br />
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 显示菜单:&nbsp;
        <input type="checkbox" id="eVis" name="eVis" runat="server" /><br />
        <br />
        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
