...
namespace DAL
{
    public class PointsDAL
    {
        ...
        {
            sql = "select T_POWERTAG,T_WINDTAG,T_ELECTRICTAG,T_STOPTIMETAG,T_FAULTTYPE,T_EXPLAINTYPE,T_CALCTIMETYPE,T_WUGONGGLVT_GONGLVYINSHU,T_GONGLVYINSHUSHEDINGZHI,";
